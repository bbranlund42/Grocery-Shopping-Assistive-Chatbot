...
export default function DevPage(){
    ...
    <form style={{margin:'10px', padding: '10px'}}>
        ...
        onChange={(e)=> setItem({...item, product_id: e.target.value})}type='text' value={item.product_id}
        ...
        <form style={{margin: '10px', padding: '10px'}}>
        <button style={{marginRight: '50px', border: '2px solid blue', padding: '5px'}} onClick={addItem}>Click here to submit</button>
        </form>
    </div>
); 
}; 
